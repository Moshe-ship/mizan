...
Expected: all tests pass (131 at time of writing), across Python 3.10–3.13 in CI.
...
```bash
curl -s https://pypi.org/integrity/mizan/0.1.22/mizan-0.1.22-py3-none-any.whl/provenance \
